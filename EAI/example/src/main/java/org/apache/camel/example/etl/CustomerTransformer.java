...
/**
 * Transformiert die Nachricht von einem XML Customer zu einer Customer Bean
 * 
 * @version 2015-02-28
 * @author Apache Camel
 */
...
public final class CustomerTransformer {
    ...
    /**
     * Konvertiert ein Person Document zu einem Customer
     * @param doc XML File
     * @param exchange
    ...
    /**
     * Sucht nach einem Customer per Name
